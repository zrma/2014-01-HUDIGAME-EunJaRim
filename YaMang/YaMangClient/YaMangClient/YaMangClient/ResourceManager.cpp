...
void ResourceManager::Init()
{
	...
	AddMesh( MODEL_CORPS_DESTROY_A, MESH_KEY_CORPS_DESTROY );
	AddMesh( MODEL_CORPS_DEFENSE_A, MESH_KEY_CORPS_DEFENSE );
	AddMesh( MODEL_CORPS_RUSH_A, MESH_KEY_CORPS_RUSH );
